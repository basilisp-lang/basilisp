...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("##Inf", "(pr-str ##Inf)"),
        ("##-Inf", "(pr-str ##-Inf)"),
        ("##NaN", "(pr-str (bigdec ##NaN))"),
        ("##Inf", "(pr-str (bigdec ##Inf))"),
        ("##-Inf", "(pr-str (bigdec ##-Inf))"),
        ('"hi"', '(pr-str "hi")'),
        ("sym", "(pr-str 'sym)"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (re.compile(r"\\b."), '(read-string (pr-str #"\\b."))'),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("-Infinity", "(print-str ##-Inf)"),
        ("NaN", "(print-str (bigdec ##NaN))"),
        ("Infinity", "(print-str (bigdec ##Inf))"),
        ("-Infinity", "(print-str (bigdec ##-Inf))"),
        ("sym", "(print-str 'sym)"),
