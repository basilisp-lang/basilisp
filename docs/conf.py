...
# The default code highlighting language to use for the project.
...
man_pages = [(master_doc, "basilisp", "Basilisp Documentation", [author], 1)]
...
def lpy_linkcode_resolve(filename, lines):
    ...
    return (
        f"https://github.com/basilisp-lang/basilisp/blob/{_vcs_branch}/{p}{line_anchor}"
    )
